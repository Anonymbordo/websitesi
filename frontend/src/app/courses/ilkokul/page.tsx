      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center">
          <Card className="relative bg-gradient-to-br from-white via-orange-50/30 to-pink-50/30 backdrop-blur-lg border-2 border-white/50 shadow-2xl rounded-[2.5rem] max-w-4xl mx-auto overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-orange-300/20 to-pink-300/20 rounded-full blur-3xl pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-blue-300/20 to-purple-300/20 rounded-full blur-3xl pointer-events-none"></div>
