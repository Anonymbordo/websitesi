...
export default function FenBilimleriBox3() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-8">
      <div className="max-w-3xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-green-700 mb-4">3. Sınıf Fen Bilimleri</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="shadow-lg">
            <CardContent className="p-6 flex flex-col items-center">
              ...
              <p className="text-gray-600 text-center mb-4">3. sınıf fen bilimleri konularının detaylı anlatımları.</p>
