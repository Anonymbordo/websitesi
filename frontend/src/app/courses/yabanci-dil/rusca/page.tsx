...
export default function RuscaPage() {
  const router = useRouter()

  const levels = [
    { id: 'a1', title: 'A-1', name: 'Başlangıç', desc: 'Temel kelime ve ifadeler', color: 'from-gray-600 to-red-500', emoji: '🌱' },
    { id: 'a2', title: 'A-2', name: 'Temel', desc: 'Günlük konuşmalar', color: 'from-gray-700 to-red-500', emoji: '🌿' },
    { id: 'b1', title: 'B-1', name: 'Orta', desc: 'Bağımsız kullanım', color: 'from-red-500 to-orange-500', emoji: '🌊' },
    { id: 'b2', title: 'B-2', name: 'Orta Üstü', desc: 'Akıcı iletişim', color: 'from-orange-400 to-amber-500', emoji: '🌌' },
    { id: 'c1', title: 'C-1', name: 'İleri', desc: 'Etkili ve esnek kullanım', color: 'from-amber-500 to-yellow-500', emoji: '⭐' },
    { id: 'c2', title: 'C-2', name: 'Profesyonel', desc: 'Ana dil seviyesi', color: 'from-yellow-500 to-red-500', emoji: '👑' }
  ]

  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-100 via-red-50 to-pink-100"></div>
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gray-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-red-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-8 py-4 bg-white/90 backdrop-blur-md rounded-full border-2 border-gray-200/50 shadow-xl mb-8 hover:scale-105 transition-transform duration-300">
            <span className="text-5xl mr-4 drop-shadow-lg">🇷🇺</span>
            <span className="text-lg text-gray-700 font-bold tracking-wide">RUSÇA</span>
          </div>
          
          <h1 className="text-6xl md:text-7xl font-extrabold mb-8 relative">
            <span className="bg-gradient-to-r from-gray-700 via-red-600 to-pink-600 bg-clip-text text-transparent drop-shadow-lg">
              Rusça Seviyeler
            </span>
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-40 h-1 bg-gradient-to-r from-gray-700 to-red-500 rounded-full"></div>
          </h1>
          
          <p className="text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed font-medium mt-8">
            CEFR standartlarına uygun seviye seçimi yaparak Rusça öğrenmeye başlayın
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {levels.map((level, index) => (
            <Card 
              ...
              onClick={() => router.push(`/courses/yabanci-dil/rusca/${level.id}`)}
              style={{
            ...
            >
              ...
              <CardContent className="relative p-8 text-center space-y-4">
                ...
                <div className="pt-2">
                  <Button 
                    onClick={(e) => {
                      e.stopPropagation()
                      router.push(`/courses/yabanci-dil/rusca/${level.id}`)
                    }}
              ...
              <div className="absolute bottom-4 left-4 w-2 h-2 bg-red-400 rounded-full animate-pulse opacity-40"></div>
            </Card>
          ))}
        </div>
        ...
        <div className="text-center">
          <Card className="relative bg-gradient-to-br from-gray-700 via-red-500 to-pink-500 border-0 shadow-3xl rounded-[2.5rem] max-w-4xl mx-auto overflow-hidden">
            {/* Animated Shine */}
